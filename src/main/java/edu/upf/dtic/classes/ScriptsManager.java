...
public class ScriptsManager {
	...
	private ScriptsManager(){
		...
		modulesInfo.put("5", new FileFormInfo("mod05a.praat", "Module 5: PPh boundary detection (word segments)"));
		modulesInfo.put("6", new FileFormInfo("mod05b.praat", "Module 5: PPh boundary detection (raw speech)"));
		modulesInfo.put("7", new FileFormInfo("mod06a.praat", "Module 6: PPh prominence detection (word segments)"));
